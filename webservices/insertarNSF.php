...
$valor_ind = calc_indice_NSF($PO2, $DBO, $CF, $pH);
$color = calc_color_NSF($valor_ind);
...
if (strcmp($flag, "true") == 0) {
    ...
    fwrite($file, "Listo foto 1\n");
    if (isset($_POST['foto_editable1'])) {
        fwrite($file, "Estoy en la segunda foto\n");
        $nombre = "foto".$indice_foto;
        fwrite($file, "Nombre $nombre \n");
